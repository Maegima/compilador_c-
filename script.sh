...
g++ -Wall -o compilador.exe main.o Scanner.o Parser.o Register.o CodeGenerator.o TreeNode.o LineList.o BucketList.o SymbolTable.o Semantic.o VariablesTable.o Code.o AssemblyGenerator.o Assembler.o -ly -lfl
rm *.o
