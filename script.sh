...
#rm parser.tab.o
g++ -c main.cpp Scanner.cpp utils/TreeNode.cpp Parser.cpp utils/code.c utils/CodeGenerator.cpp utils/LineList.cpp utils/BucketList.cpp utils/SymbolTable.cpp utils/Semantic.cpp
echo compilando objetos ...
g++ -o compilador.exe main.o Scanner.o parser.o CodeGenerator.o code.o TreeNode.o LineList.o BucketList.o SymbolTable.o Semantic.o -ly -lfl
rm *.o
