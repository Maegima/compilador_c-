...
#rm parser.tab.o
g++ -Wall -c main.cpp Scanner.cpp utils/TreeNode.cpp Parser.cpp utils/CodeGenerator.cpp utils/LineList.cpp utils/BucketList.cpp utils/SymbolTable.cpp utils/Semantic.cpp utils/RegisterTable.cpp
echo compilando objetos ...
g++ -Wall -o compilador.exe main.o Scanner.o parser.o CodeGenerator.o TreeNode.o LineList.o BucketList.o SymbolTable.o Semantic.o RegisterTable.o -ly -lfl
rm *.o
