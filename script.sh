...
#rm parser.tab.o
g++ -c main.cpp Scanner.cpp utils/TreeNode.cpp Parser.cpp utils/analyze.cpp utils/symtab.cpp utils/code.c utils/cgen.cpp utils/LineList.cpp utils/BucketList.cpp
echo compilando objetos ...
g++ -o compilador.exe main.o Scanner.o parser.o analyze.o symtab.o cgen.o code.o TreeNode.o LineList.o BucketList.o -ly -lfl
rm *.o
